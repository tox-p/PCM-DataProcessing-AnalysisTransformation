...
public class FlowItemProvider extends EntityItemProvider {
	...
	protected void addStartNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_startNode_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_startNode_feature", "_UI_Flow_type"),
						FlowPackage.Literals.FLOW__START_NODE, true, false, true, null, null, null));
	}
	...
	protected void addEndNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_endNode_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_endNode_feature", "_UI_Flow_type"),
						FlowPackage.Literals.FLOW__END_NODE, true, false, true, null, null, null));
	}
	...
	protected void addDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_data_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_data_feature", "_UI_Flow_type"),
						FlowPackage.Literals.FLOW__DATA, true, false, true, null, null, null));
	}
