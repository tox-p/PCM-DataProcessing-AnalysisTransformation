...
import edu.kit.ipd.sdq.dataflow.privacy.analysis.metamodel.characteristics.provider.CharacteristicsHavingElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.dataflow.privacy.analysis.metamodel.flow.NodeContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeContainerItemProvider extends CharacteristicsHavingElementItemProvider {
	/**
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IdHavingElement_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IdHavingElement_id_feature",
								"_UI_IdHavingElement_type"),
						MetamodelPackage.Literals.ID_HAVING_ELEMENT__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NameHavingElement_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_NameHavingElement_name_feature",
								"_UI_NameHavingElement_type"),
						MetamodelPackage.Literals.NAME_HAVING_ELEMENT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FlowPackage.Literals.NODE_CONTAINER__NODES);
		}
	...
	/**
	 * This returns NodeContainer.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NodeContainer"));
	}
