...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.dataflow.privacy.analysis.metamodel.flow.DataFlowDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFlowDiagramItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FlowPackage.Literals.DATA_FLOW_DIAGRAM__NODECONTAINER);
			childrenFeatures.add(FlowPackage.Literals.DATA_FLOW_DIAGRAM__DATA);
			childrenFeatures.add(FlowPackage.Literals.DATA_FLOW_DIAGRAM__FLOW);
		}
	...
	public String getText(Object object) {
		return getString("_UI_DataFlowDiagram_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(FlowPackage.Literals.DATA_FLOW_DIAGRAM__NODECONTAINER,
				FlowFactory.eINSTANCE.createNodeContainer()));

		newChildDescriptors.add(
				createChildParameter(FlowPackage.Literals.DATA_FLOW_DIAGRAM__DATA, FlowFactory.eINSTANCE.createData()));

		newChildDescriptors.add(
				createChildParameter(FlowPackage.Literals.DATA_FLOW_DIAGRAM__FLOW, FlowFactory.eINSTANCE.createFlow()));
	}
