 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.privacy.analysis.metamodel.characteristics.impl.EnumImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumImpl extends EntityImpl
		implements edu.kit.ipd.sdq.dataflow.privacy.analysis.metamodel.characteristics.Enum {
	/**
	...
	protected EClass eStaticClass() {
		return CharacteristicsPackage.Literals.ENUM;
	}
	...
	public EList<EnumLiteral> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<EnumLiteral>(EnumLiteral.class, this,
					CharacteristicsPackage.ENUM__LITERALS);
		}
		return literals;
	}
