 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.dataflow.privacy.analysis.metamodel.impl.EntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EntityImpl extends IdHavingElementImpl implements Entity {
	/**
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NameHavingElement.class) {
			...
			case MetamodelPackage.NAME_HAVING_ELEMENT__NAME:
				return MetamodelPackage.ENTITY__NAME;
			default:
				return -1;
			}
		}
